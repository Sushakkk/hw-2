...
const Loader: React.FC<LoaderProps> = ({ size = 'l', className = '', color = '#518581' }) => {
    ...
    const renderSVG = () => {
        switch (size) {
            case 's':
                return (
                    <svg className={`loader-container ${className}`} data-testid="loader" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            case 'm':
                return (
                    <svg className={`loader-container ${className}`} data-testid="loader" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            default:
                return (
                    <svg className={`loader-container ${className}`} data-testid="loader" width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
